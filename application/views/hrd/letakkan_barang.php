    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="container-fluid">
        <div class="alert bg-content" role="alert">
          <i class="fas fa-plus-square"></i> Letakkan Aset Peralatan dan Perlengkapan Kantor
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
              <div class="card mb-4 py-3 border-left-danger">
                ...
                <form method="post" action="<?php echo base_url('user/kantor/letakkan_aksi') ?>">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="number" name="baik" placeholder="Masukkan Jumlah Barang Kondisi Baik" class="form-control" required>
