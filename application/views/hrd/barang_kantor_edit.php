        ...
        <div class="row">
            ...
            <div class="col-md-6">
              <div class="card mb-4 py-3 border-left-danger">
                <div class="card-body">
                  ...
                  <b> <nav aria-label="breadcrumb">
                        <ol class="breadcrumb" style="background: #fce6e8;">
                          <li class="breadcrumb-item"><?php echo anchor('user/kantor','<i class="far fa-edit"></i> Kelola Barang'); ?></li>
                ...
                <form method="post" action="<?php echo base_url('user/kantor/barang_kantor_update') ?>">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="number" name="tahun" value="<?php echo $bg->tahun_perolehan;?>" class="form-control" required>
