        ...
        <div class="row">
            ...
            <div class="col-md-6">
              <div class="card mb-4 py-3 border-left-danger">
                ...
                <form method="post" action="<?php echo base_url().'hrd/karyawan/update'; ?>">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Nama Subbidang</label>
                    <div class="col-sm-8">
                      <select name="subbidang" class="form-control select2" style="width: 100%;" required="required">
                        <option value="<?php echo $kr->id_subbidang;?>"><?php echo $kr->nama_subbidang;?></option>
